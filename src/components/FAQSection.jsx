    ...
    <section id="faq" className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <p className="text-blue-700 text-sm font-bold md:text-lg lg:font-semibold mb-2">FAQ</p>
          <h2 className="text-2xl md:text-3xl font-semibold text-gray-900 mb-4">
            คำถามที่พบบ่อย
          </h2>
          <p className="text-sm text-gray-600 md:text-lg lg:font-normal max-w-2xl mx-auto">
